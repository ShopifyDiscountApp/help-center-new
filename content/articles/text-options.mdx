...
description: "Complete guide to using single-line text input options in Optionify for names, short messages, and custom text personalization."
category: "option-types"
lastUpdated: "2024-01-15"
tags: ["text", "input", "personalization", "option types"]
featured: false
order: 4
---
...
\![Text option example on product page](/images/text-options/text-input-example.png)
*A text option field for engraving on a jewelry product*
...
\![Text option configuration screen](/images/text-options/text-config-screen.png)
*Configure your text option with labels and help text*
...
\![Placeholder text example](/images/text-options/placeholder-example.png)
*Helpful placeholder text guides customers*
